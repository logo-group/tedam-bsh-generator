...
public class BaseTedamTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(BaseTedamTest.class);
	 ...
	 * @return <br>
	 */
	protected String getFileParentPathFromSourceName(String sourceName) {
		URL resource = getClass().getResource(sourceName);
		File file = null;
		try {
			file = (Paths.get(resource.toURI()).toFile()).getParentFile();
	...
	/**
	 * this method getTempdir is fetch defined temp file.<br>
	 * @author Tarik.Mikyas
	 * @return <br>
	 */
